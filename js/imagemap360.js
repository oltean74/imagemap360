            ...
            $.fn.imagemap360 = function(options) {
                this.each(function() {
                    ...
                    pC.css('height', eh + 'px').css('overflow', 'hidden').wrap("<div class='imagemap360-viewport'></div>").parent().css('width', settings.viewport_width + 'px')
                        .append("<div class='imagemap360-control'><a href='#' class='imagemap360-control-left'><img src='icons/Back.png'/></a> <a href='#fullscreen' class='imagemap360-control-full'><img src='icons/ArrowOut.png'/></a> <a href='#normal' class='imagemap360-control-nofull'><img src='icons/ArrowIn.png'/></a> <a href='#' class='imagemap360-control-right'><img src='icons/Forward.png'/></a><a class='combo'><select><option value='100000'>Slow</option><option value='50000' selected>Normal</option><option value='30000'>Fast</option></select></a></div>");
